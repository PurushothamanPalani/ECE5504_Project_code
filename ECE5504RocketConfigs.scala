...
class ECE5504RocketPrefetchConfig extends Config(
  new freechips.rocketchip.subsystem.WithNonblockingL1(nMSHRs = 8) ++ // use non-blocking L1D
...
// No prefetcher = NB-DC
// Prefetcher = HW Prefetcher


// No Prefetcher = Normal cache
// Prefetcher = NB-DC, (HW Prefetcher, optional)